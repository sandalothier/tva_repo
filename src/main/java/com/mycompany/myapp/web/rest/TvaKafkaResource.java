...
@RestController
@RequestMapping("/api/tva-kafka")
public class TvaKafkaResource {
    private final Logger log = LoggerFactory.getLogger(TvaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TvaKafkaResource(KafkaProperties kafkaProperties) {
